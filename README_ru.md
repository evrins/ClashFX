...
> Канал Lab доступен начиная с **v1.1.0**. Stable остаётся по умолчанию и рекомендуется большинству пользователей; если вы на v1.1.0+, переключиться можно в `Настройки → Отладка → Канал обновлений → Lab (экспериментальный)`.
